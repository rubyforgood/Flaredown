...
ActiveRecord::Schema.define(version: 20_160_211_105_611) do
  ...
  add_index 'trackings', %w(trackable_type trackable_id), name: 'index_trackings_on_trackable_type_and_trackable_id', using: :btree
  add_index 'trackings', ['trackable_type'], name: 'index_trackings_on_trackable_type', using: :btree
  add_index 'trackings', %w(user_id trackable_id trackable_type start_at), name: 'index_trackings_unique_trackable', unique: true, using: :btree
